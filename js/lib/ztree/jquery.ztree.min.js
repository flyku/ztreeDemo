	...
	var G, H, I, J, K, L, r = {}, u = {}, v = {}, M = {
		...
		s = [
			function(b) {
				...
				if (j.eqs(b.type, "dblclick") && (l = "dblclick", k = j.getMDom(c, a, [{
					tagName: "a",
					attrName: "treeNode" + e.id.A
		...
		h = {
			...
			unbindTree: function(b) {
				b.treeObj.unbind("click", m.proxy).unbind("db", m.proxy).unbind("mouseover", m.proxy).unbind("mouseout", m.proxy).unbind("mousedown", m.proxy).unbind("mouseup", m.proxy).unbind("contextmenu", m.proxy)
			},
			doProxy: function(b) {
